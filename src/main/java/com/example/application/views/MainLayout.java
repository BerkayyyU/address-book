 ...
 */
@PWA(name = "Adres Defteri", shortName = "Adres Defteri", enableInstallPrompt = false)
...
public class MainLayout extends AppLayout {
    ...
    private HorizontalLayout createHeader() {
        ...
        Image logo = new Image("images/logo.png", "Adres Defteri logo");
        logo.setId("logo");
        header.add(logo);
        Avatar avatar = new Avatar();
        avatar.addClassNames("ms-auto", "me-m");
        header.add(new H1("Adres Defteri"));
        header.add(avatar);
        return header;
    }
